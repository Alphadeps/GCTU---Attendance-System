 ...
 * 2. Insert the already-applied migrations as baseline records so Prisma
 *    knows they are done and skips them.
 * 3. Run `prisma migrate deploy` — it will only apply any new migrations
 *    (e.g. the manualCode column addition).
 */
