...
export default function OfficialArchives() {
  ...
  if (Object.keys(groupedReports).length === 0) {
    return (
      <div className="bg-gray-100 border border-slate-800 rounded-2xl p-10 text-center">
        <div className="flex justify-center mb-4">
          <svg className="w-16 h-16 text-[#344767]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z" />
          </svg>
        </div>
        <h3 className="text-xl font-bold text-[#344767] mb-2">No Reports Archived Yet</h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          <h2 className="text-2xl font-black text-[#344767] tracking-tight">📊 Official Archives</h2>
          <p className="text-sm text-[#8392ab] mt-1">Digitally signed course attendance reports organized by programme and level.</p>
        </div>
      </div>

      {/* Filters */}
      <div className="bg-gray-100 border border-slate-800 rounded-2xl p-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#0f172a] border border-slate-800 rounded-xl px-4 py-2 text-sm text-[#344767] placeholder-slate-500 focus:outline-none focus:border-indigo-500"
            />
          </div>
          <div>
            ...
            <select
              ...
              className="w-full bg-[#0f172a] border border-slate-800 rounded-xl px-4 py-2 text-sm text-[#344767] focus:outline-none focus:border-indigo-500"
            >
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full bg-gray-200 hover:bg-gray-100 text-[#344767] text-sm font-semibold px-4 py-2 rounded-xl transition"
            >
              Clear Filters
            </button>
          </div>
      ...
      <div className="space-y-4">
        {Object.entries(filteredReports).map(([programmeName, levels]) => {
          ...
          return (
            <div key={programmeName} className="bg-gray-100 border border-slate-800 rounded-2xl overflow-hidden">
              {/* Programme Level */}
              <button
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <h3 className="text-lg font-bold text-[#344767]">{programmeName}</h3>
                    ...
                    return (
                      <div key={level} className="bg-[#0f172a] border border-slate-800 rounded-xl overflow-hidden">
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-between p-4 bg-gray-200/30 hover:bg-gray-200/50 transition"
                        >
                          <div className="flex items-center gap-3">
                            <svg className="w-5 h-5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                            </svg>
                            <h4 className="text-md font-bold text-[#344767]">Level {level}</h4>
                            <span className="text-xs bg-gray-100 text-[#344767] px-2 py-0.5 rounded-full font-mono">
                            ...
                            {Object.entries(groups).map(([groupKey, reports]) => (
                              <div key={groupKey} className="pl-4 border-l-2 border-indigo-500/30">
                                ...
                                <div className="grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                                  {reports.map(report => (
                                    <div key={report.id} className="bg-gray-100 border border-gray-300 rounded-xl p-4 flex flex-col justify-between hover:border-indigo-500/50 transition">
                                      <div>
                                        ...
                                        <h6 className="text-[#344767] font-medium text-sm line-clamp-2 mb-1">{report.course.name}</h6>
      ...
      {Object.keys(filteredReports).length === 0 && (
        <div className="bg-gray-100 border border-slate-800 rounded-2xl p-10 text-center">
          <svg className="w-16 h-16 text-[#344767] mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
          </svg>
          <h3 className="text-lg font-bold text-[#344767] mb-2">No Reports Found</h3>
